...
public class AdminDownloadTaskApi {
	...
	@RequestMapping(value = RouteDefine.ADMIN_API + "/dld-tasks", method = RequestMethod.GET)
	public void getAll(HttpServletResponse response) {
		List<DownloadTask> tasks = rMapper.selectAll();
		HttpResponseTool.writeResponse(response, tasks);
	}

	@RequestMapping(value = RouteDefine.ADMIN_API + "/dld-tasks/{id}/actions/disable", method = RequestMethod.POST)
	...
	@RequestMapping(value = RouteDefine.ADMIN_API + "/dld-tasks/{id}/actions/enable", method = RequestMethod.POST)
